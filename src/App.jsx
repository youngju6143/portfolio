...
import { Clouds, Cloud, CameraControls, Sky, useFaceControls } from "@react-three/drei";
...
function SkyComponent({ scrollY }) {
  ...
  return (
    <>
      {/* Sky 컴포넌트 */}
      <Sky style={{width: '100%'}} distance={45000} sunPosition={[5, 1, 10]} inclination={0.6} azimuth={0.25} />
      <group ref={ref}>
